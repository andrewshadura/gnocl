...
/**
\page page_spinButton gnocl::spinButton
htmtlinclude spinButon.html
**/
...
static void spinButtonDestroyFunc ( GtkWidget *widget, gpointer data )
{
	...
	gnoclAttachOptCmdAndVar ( NULL, &para->onValueChanged,
							  NULL, &para->variable,
					   ...
					   GnoclOption options[] )
{
	...
	gnoclAttachOptCmdAndVar ( options + onValueChangedIdx, &para->onValueChanged,
