...
\history
			...
			02/06/11	implemented PixbufParams, create pixbuf with
...
int pixBufFunc ( ClientData data, Tcl_Interp *interp, int objc, Tcl_Obj * const objv[] )
{
	...
	static const char *cmds[] =
	{
		...
		"scale", "resize", "addAlpha", "options", "commands",
		NULL
	};
	...
	enum cmdIdx
	{
		...
		ScaleIdx, ResizeIdx, AddAlphaIdx, OptionsIdx, CommandsIdx
	};
	...
	switch ( idx )
	{
		...
		case OptionsIdx:
			{
				gnoclGetOptions ( interp, pixBufOptions );
			}
			break;
		case FloodIdx:
			{
