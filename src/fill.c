/**
\brief	Implement pixbuf fill command
\see 	http://code.google.com/p/gnome-paint/source/browse/trunk/src/pixbuf_util.c?spec=svn67&r=56

		void gdk_pixbuf_fill(GdkPixbuf *pixbuf, guint32 pixel, gint xc, gint yc)
