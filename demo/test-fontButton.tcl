...
set fsb1 [gnocl::fontButton \
    -fontName $fontName \
    -title "Change the Font Selected..." \
    -showSize 0 -showStyle 0 \
    -useFont 0 -useSize 0 \
    -onFontSet { puts "font = %f\n [%w cget -data] [%w cget -name]" ;
        set fontName %f
...
$mainBox add [list $ent1 [gnocl::separator] $fsb1 ]

# test the commands
puts [$fsb1 cget -title]
puts [$fsb1 configure -showSize 1 -showStyle 1]
